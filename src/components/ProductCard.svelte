...
>
  ...
  (index % 2 === 1 ? " md:order-2" : " ")}>
      ...
      <div class="flex flex-col gap-3">
          {#each productFeature.featureList as listItem}
              <div class="flex gap-2 items-center">
                  <div
                      class="grid place-items-center px-1.5 text-xs sm:text-sm aspect-square rounded-full border-[2px] bg-white border-solid border-green-400"
                  >
      ...
      <div class="flex items-center">
          <button class="specialBtnViolet mr-auto font-semibold">
