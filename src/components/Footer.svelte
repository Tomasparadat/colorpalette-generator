<footer class="py-16 sm:py-20 md:py-24 px-4 md:px-8">
  ...
  >
    <div class="flex flex-col gap-4 md:col-span-2">
      ...
      <p class="opacity-[0.6]">©2024 PALETTE GENERATOR INC. All rights reserved.</p>
    </div>
    <div class="flex flex-col gap-4">
      <p class="font-bold text-base sm:text-lg">Support</p>
      <a href="" target="_blank" class="cursor-pointer hover:text-indigo-500 duration-200"
      >Contact Us</a>
    </div>
